# Runs the daily ra_filing script to organize and consolidate Resource
# Adequacy Monthly Filings, Load Forecasts, and Allotments.
...
& anaconda-project run consolidate
& conda deactivate
& C:
If (-Not $ExistingDrive) {
    Remove-PSDrive Z
